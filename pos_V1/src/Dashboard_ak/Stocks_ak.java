...
public class Stocks_ak extends javax.swing.JFrame {
    ...
    public void retreiveProd(){
        ...
        String sql = "select * from products_ak ";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        posDashboardAk a = new posDashboardAk();
        a.setVisible(true);
        this.hide();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stocks_ak.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
