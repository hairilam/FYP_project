...
public class posDashboardAk extends javax.swing.JFrame {

   
    public posDashboardAk() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(posDashboardAk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new posDashboardAk().setVisible(true);
            }
        });
    }
