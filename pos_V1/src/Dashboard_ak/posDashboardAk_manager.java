...
public class posDashboardAk_manager extends javax.swing.JFrame {

   
    public posDashboardAk_manager() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(posDashboardAk_manager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new posDashboardAk_manager().setVisible(true);
            }
        });
    }
