...
import static Dashboard_MidValley.posDashboardMid.jLabel_branchName;
import static Dashboard_MidValley.posDashboardMid.jLabel_cashiername;
import static Dashboard_MidValley.posDashboardMid.jLabel_positionname;
import static Dashboard_MidValley.posDashboardMid.logOutlet;
import static Dashboard_MidValley.posDashboardMid.logPosition;
import static Dashboard_MidValley.posDashboardMid.logUser;
...
public class Stocks_mid extends javax.swing.JFrame {

    public static String logUser;
   public static String logOutlet;
   public static String logPosition;
    public Stocks_mid(String user,String outlet,String position) {
        initComponents();
    ...
    public void retreiveProd(){
        ...
        String sql = "select * from products_mid ";
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Prodcut Id", "Product Name", "Product Type", "Product Category", "Product Color", "Product Size", "Quantity", "Sell Price", "Buy Price"
            }
        ) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        posDashboardMid a = new posDashboardMid(logUser,logOutlet,logPosition);
        a.setVisible(true);
        this.hide();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stocks_mid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Stocks_mid(logUser,logOutlet,logPosition).setVisible(true);
            }
        });
    }
