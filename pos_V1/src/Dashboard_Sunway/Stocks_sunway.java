...
public class Stocks_sunway extends javax.swing.JFrame {

   
    public Stocks_sunway() {
        initComponents();
    ...
    public void retreiveProd(){
        ...
        String sql = "select * from products_sunway ";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        posDashboardSunway a = new posDashboardSunway();
        a.setVisible(true);
        this.hide();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stocks_sunway.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Stocks_sunway().setVisible(true);
            }
        });
    }
