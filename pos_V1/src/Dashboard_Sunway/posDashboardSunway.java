...
public class posDashboardSunway extends javax.swing.JFrame {

   
    public posDashboardSunway() {
        initComponents();
    ...
    public void retreiveProd(){
        ...
        String sql = "select prod_id,prod_name,prod_color,prod_qty,buy_price from products_1 ";
        
        try {
            Connection con= (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/lam", "root", "");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Prodcut Id", "Product Name", "Product Color", "Quantity", "Price"
            }
        ) {
    ...
    private void InventoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InventoryActionPerformed
       Stocks_sunway ss = new Stocks_sunway();
       ss.setVisible(true);
       this.hide();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(posDashboardSunway.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new posDashboardSunway().setVisible(true);
            }
        });
    }
