...
public class posDashboardSunway_manager extends javax.swing.JFrame {

   
    public posDashboardSunway_manager() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(posDashboardSunway_manager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new posDashboardSunway_manager().setVisible(true);
            }
        });
    }
